...
import type { IOperatorFilterRegistry, IOperatorFilterRegistryInterface } from "../IOperatorFilterRegistry";
...
export class IOperatorFilterRegistry__factory {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): IOperatorFilterRegistry {
    return new Contract(address, _abi, signerOrProvider) as IOperatorFilterRegistry;
  }
}
